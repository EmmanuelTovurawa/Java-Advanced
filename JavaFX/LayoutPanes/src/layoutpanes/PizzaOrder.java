...
public class PizzaOrder extends Application {
    ...
    public void start(Stage primaryStage) {
        stage = primaryStage;
// Create the name label and the text input field/s 
...
// Create both the address label and text field 
...
// Create the size pane with a label
...
// Create the crust pane with this label
...
// Create the toppings pane ie toppings
...
// Create the buttons ie the buttons
...
// Create the GridPane layout ie layout
...
// Set the column widths ie the widths
...
// Create the scene and the stagee 
...
// We Create a message string with the customer informationn
        String msg = "Customer:\n\n";
        msg += "\t" + txtName.getText() + "\n";
...
// Add the toppings for the pizza/s
        String toppings = "";
